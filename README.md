...
Hydra.NET is a simple library that provides building blocks for creating hypermedia-driven Web APIs with the [Hydra specification](https://www.hydra-cg.com/spec/latest/core/) in .NET.
